...
Fetch a data frame of all local authority districts for a given year and
country based on the dfeR::geo_hierarchy file.
...
- countries:
  ...
  vector of desired countries to filter the locations to, default is
  "All", or can be a vector with options of "England", "Scotland",
