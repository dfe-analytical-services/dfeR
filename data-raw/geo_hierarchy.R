# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Create the geo_hierarchy data set
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# NOTE: Other hierarchies are available, but we expect this to be the main one
# for analysts working in DfE.
#
...
#    The source lookups are published out of sync, so the years aren't a perfect
...
geo_hierarchy <- wd_pcon_lad_la_cauth_rgn_ctry |>
  dplyr::mutate(
...
region_error_check <- geo_hierarchy |>
  dplyr::filter(
    region_code == "" |
      region_name == "" |
      is.na(region_name) |
...
country_error_check <- geo_hierarchy |>
