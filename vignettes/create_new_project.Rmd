...
parameter_data <- data.frame(
  ...
  Considerations = c(
    ...
    "Do you want to use renv for package version control? Set to TRUE if you want to use it.",
  ...
  Outout = c(
    ...
    "If set to TRUE, a publication template folder structure will be created, with folders for data,                analysis, documentation and misc. If set to FALSE, a basic analysis folder structure will be created,               with folders for data, analyis and output",
