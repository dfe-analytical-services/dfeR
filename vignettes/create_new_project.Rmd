...
parameter_data <- data.frame(
  ...
  Considerations = c(
    ...
    Set to TRUE if yes or FALSE if it is for another type of analysis.",
  ...
  Outout = c(
    ...
    A renv folder will be created, as well as a renv.lock file.",
    "If set to TRUE, an additonal folder will be created specifically
    for package development",
    "If set to TRUE, a publication template folder structure will be created,
    with folders for data, analysis, documentation and misc. 
    If set to FALSE, a basic analysis folder structure will be created,
    with folders for data, analyis and output",
