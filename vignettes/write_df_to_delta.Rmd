...
vignette: >
  %\VignetteIndexEntry{Scalable Bulk Writing to Databricks: write_df_to_delta}
...
```{r, echo = FALSE, eval = !can_plot, results = "asis"}
...
```{r benchmarks_plot, echo = FALSE, eval = can_plot, message = FALSE, warning = FALSE, fig.cap = "Figure 1: Performance comparison between DBI and dfeR across increasing row counts."}
...
```{r stress_test_plot, echo = FALSE, eval = can_plot, message = FALSE, warning = FALSE, fig.cap = "Figure 2: Performance resiliency testing from 100 to 1 billion rows, showing stable execution times."}
