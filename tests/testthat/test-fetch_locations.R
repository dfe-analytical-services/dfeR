...
test_that("year filtering works as expected", {
  # PCONs
  expect_equal(
    fetch_pcons(c("2017", "2019", "2020", "2021", "2022", "2023", "2024")) |>
      nrow(),
    1295
  )
  # TODO: expect_equal(nrow(fetch_pcons(c("2022", "2023"))), 650)

  # LADs
  expect_equal(
    fetch_lads(c("2017", "2019", "2020", "2021", "2022", "2023", "2024")) |>
      nrow(),
    408
  )
  # TODO: expect_equal(nrow(fetch_lads(c("2024", "2023"))), 400)

  # LAs
  # TODO: expect_equal(nrow(fetch_las(c("2017",
  # TODO: "2019", "2020", "2021", "2022", "2023", "2024"))), 399)
  # TODO:expect_equal(nrow(fetch_las(c("2024", "2023"))), 399)
})
...
test_that("2024 locations match what we expect", {
  ...
  # LAs
  # TODO: expect_equal(nrow(fetch_las("2024")), 220)
  # TODO: expect_equal(nrow(fetch_las("2024", c("England",
  # todo: "Scotland", "Wales"))), 207)
  # TODO: expect_equal(nrow(fetch_las("2024", "England")), 153)
  # TODO: expect_equal(nrow(fetch_las("2024", "Scotland")), 32)
